...
class CameraGUI(QWidget):
    ...
    def initUI(self):
        ...
        angle_input_layout.addWidget(self.shoot_angle_input)
        angle_input_layout.addWidget(self.shoot_angle_button)
        ...
        move_input_layout.addWidget(self.move_angle_input)
        move_input_layout.addWidget(self.move_angle_button)
        angle_layout.addLayout(move_input_layout)
